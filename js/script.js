    <script>
        // JSON data containing fruit information
        const fruitData = [
					{
    "genus": "Malus",
    "name": "Apple",
    ...
    "nutritions": {
      ...
      "sugar": 6
        ...
        function submitOrder() {
            ...
            // Find the selected fruits in the fruitData array
            ...
            const outputText = `
                ...
                Total Carbohydrates: ${totalCarbohydrates.toFixed(2)}g
        ...
        // Populate select elements with fruit options on page load
        window.addEventListener('load', populateSelectElements);
    </script>